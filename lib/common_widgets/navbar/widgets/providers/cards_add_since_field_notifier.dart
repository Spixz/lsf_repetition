...
final cardsAddSinceFieldProvider = AutoDisposeNotifierProvider(
  CardsAddSinceFieldNotifier.new,
);

class CardsAddSinceFieldNotifier extends AutoDisposeNotifier<TextFieldState> {
  int _nbDays = 1;
